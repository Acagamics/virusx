...
namespace VirusX.Menu
{
    class Paused : MenuPage
    {
            ...
            : base(menu)
        {
            ...
            // paused string
            string label = VirusXStrings.Instance.PauseScreenCaption;
            ...
            Interface.Add(new InterfaceButton((string)VirusXStrings.Instance.PauseScreenContinue, new Vector2(-20 - BUTTON_WIDTH, y), () => { return currentButton == Buttons.CONTINUE; }, BUTTON_WIDTH, Alignment.CENTER_CENTER));
            Interface.Add(new InterfaceButton((string)VirusXStrings.Instance.PauseScreenQuitToMenu, new Vector2(20, y), () => { return currentButton == Buttons.QUIT_TO_MAINMENU; }, BUTTON_WIDTH, Alignment.CENTER_CENTER));
            y += 100;

            // disconnected message
            for(int i=0; i<4; ++i)
            {
                string message = VirusXStrings.Instance.PauseScreenPlayerDisconnected_player + (i + 1) + VirusXStrings.Instance.PauseScreenPlayerDisconnected_disconnected;
