...
namespace VirusX.Menu
{
    class NewGame : MenuPage
    {
        ...
        public override void OnActivated(Menu.Page oldPage, GameTime gameTime)
        {
            ...
            if (oldPage != Menu.Page.CONTROLS && oldPage != Menu.Page.STATS)
            {
                ...
                for (int i = 0; i < numSlots; i++)
                {
                    ...
                    Interface.Add(new InterfaceButton(
                        () => { return playerReadyBySlot[index] ? VirusXStrings.Instance.Get("NewGameReady") : VirusXStrings.Instance.Get("NewGameNotReady"); },
                ...
                if (numSlots > 1)
                {
                    ...
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameRemoveComputer"), new Vector2(-295, textBoxHeight), () => false, () => !InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                    ...
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameAddComputer"), new Vector2(-15, textBoxHeight), () => false, () => !InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                    ...
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameShowControls"), new Vector2(215, textBoxHeight), () => false, () => !InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                    ...
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameAddComputer"), new Vector2(-65, textBoxHeight), () => false, () => InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                    ...
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameShowControls"), new Vector2(165, textBoxHeight), () => false, () => InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                }
                else
                {
                    // help text pad
                    ...
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameShowControls"), new Vector2(-15, textBoxHeight), () => false, () => !InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                
                    // help text keyboard
                    Interface.Add(new InterfaceButton("F1", new Vector2(-115, textBoxHeight), () => true, () => InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 50, Alignment.BOTTOM_CENTER));
                    Interface.Add(new InterfaceButton(VirusXStrings.Instance.Get("NewGameShowControls"), new Vector2(-65, textBoxHeight), () => false, () => InputManager.IsKeyboardControlType(Settings.Instance.StartingControls), 180, Alignment.BOTTOM_CENTER));
                }
                ...
                // countdown
                String text = VirusXStrings.Instance.Get("NewGameStartsIn") + ((int)countdown.TotalSeconds + 1).ToString() + "...";
                ...
                InterfaceButton countdownButton = new InterfaceButton(() => { return VirusXStrings.Instance.Get("NewGameStartsIn") + ((int)countdown.TotalSeconds + 1).ToString() + "..."; }, new Vector2(Settings.Instance.ResolutionX / 2, Settings.Instance.ResolutionY / 2) - (size / 2), () => { return !(countdown.TotalSeconds > safeCountdown); }, () => { return countdown.TotalSeconds > 0; }, true);
        ...
        private string GetJoinText(int index)
        {
            ...
            //else
            if (Settings.Instance.GameMode == Game.GameMode.CAPTURE_THE_CELL)
                return VirusXStrings.Instance.Get("NewGameJoinHelpText") + "\n\n" + VirusXStrings.Instance.Get("NewGameCTCHelpText");
            else
                return VirusXStrings.Instance.Get("NewGameJoinHelpText");
        }
