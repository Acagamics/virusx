...
namespace VirusX
{
    ...
    class Statistics
    {
        ...
        public int getDeathStepOfPlayer(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? deathStep[playerIndex] : -2; }
        /// <summary>
       ...
       // public ulong getGeneratedParticles(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? generatedParticles[playerIndex] : 0; }
        ...
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getCapturedSpawnPoints(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? capturedSpawnPoints[playerIndex] : 0; }
        /// <summary>
        /// The total amount of lost SpawnPoints/spawnPoints
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getLostSpawnPoints(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? lostSpawnPoints[playerIndex] : 0; }
        /// <summary>
        /// The amount of won matches
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getWonMatches(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? wonMatches[playerIndex] : 0; }
        /// <summary>
        /// the total amount of collected items
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getCollectedItems(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? collectedItems[playerIndex] : 0; }
        /// <summary>
        /// the total amount of used items
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getUsedItems(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? usedItems[playerIndex] : 0; }
        /// <summary>
        /// Not tracked yet. The amount of killed enemys
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getKilledEnemies(int playerIndex) { return (playerIndex < playerCount && playerIndex >= 0) ? killedEnemies[playerIndex] : 0; }
        ...
        /// <returns></returns>
        public float getDominationInStep(int playerIndex, int step)
        { return (step < steps && playerIndex < playerCount && playerIndex >= 0) ? dominationInStep[playerIndex][step] : 0; }
        ...
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getMaxSimultaneousParticles(int playerIndex)
        { return (playerIndex < playerCount && playerIndex >= 0) ? maxSimultaneousParticles[playerIndex] : 0; }
        /// <summary>
        /// The average number of particles in a game
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getAverageParticles(int playerIndex)
        { return (playerIndex < playerCount && playerIndex >= 0) ? averageParticles[playerIndex] : 0; }
        /// <summary>
        /// The average healt in a game
        /// </summary>
        /// <param name="playerIndex"></param>
        /// <returns></returns>
        public uint getAverageHealth(int playerIndex)
        { return (playerIndex < playerCount && playerIndex >= 0) ? averageHealth[playerIndex] : 0; }
        ...
        /// <param name="step"></param>
        /// <returns></returns>
        public uint getParticlesInStep(int playerIndex, int step)
        { return (step < steps && playerIndex < playerCount && playerIndex >= 0) ? particlesInStep[playerIndex][step] : particlesInStep[0][steps - 1]; }
        ...
        /// <param name="step"></param>
        /// <returns></returns>
        public uint getHealthInStep(int playerIndex, int step)
        { return (step < steps && playerIndex < playerCount && playerIndex >= 0) ? healthInStep[playerIndex][step] : healthInStep[0][steps-1]; }
