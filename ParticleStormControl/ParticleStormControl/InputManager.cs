...
namespace VirusX
{
    class InputManager
    {
        ...
        /// <summary>
        /// converts Keys enum to char
        /// </summary>
        /// <param name="key"></param>
        /// <param name="shift"></param>
        /// <returns>\0 if conversion not possible</returns>
        public static char ConvertKeyboardInput(Keys key, bool shift = false)
        {
            switch (key)
            {
                //Alphabet keys
                ...
                case Keys.OemMinus: if (shift) { return '-'; } else { return '-'; }
